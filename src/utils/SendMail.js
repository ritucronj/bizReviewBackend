...
const sendVerifyEMail = async (name, email, uId) => {
  try {
    ...
    const mailOptions = {
      ...
      html: `<p> Hi  ${name}
        , <br><br>  Click this link to verify your BizReview account.<br> <br> <a href="http://206.81.14.11:3000/createPassword?id=${uId}"> Verification Link</a> <br> <br> The BizReview Team`,
    };
